    ...
    <header className="bg-[var(--color-background)] border-b border-[var(--color-border)] sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-3">
                  ...
                  <a
                    ...
                    className={cn(
                      ...
                      active
                        ...
                        : "text-[var(--color-muted-foreground)] hover:text-[var(--color-text-primary)]"
                    )}
          ...
          <button
            type="button"
            className="md:hidden shrink-0 rounded-md p-2 text-[var(--color-text-primary)] hover:bg-[var(--color-muted)]"
