...
export interface SharedProps extends Struct.ComponentSchema {
  collectionName: 'components_shared_props';
  info: {
    displayName: 'props';
  };
  attributes: {
...
export interface SharedSlug extends Struct.ComponentSchema {
