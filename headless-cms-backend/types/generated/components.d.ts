...
export interface BlocksAccordion extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Expandable panel; nesting via slots JSON';
...
export interface BlocksButton extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Button container (nests Icon and/or Text)';
    displayName: 'Button';
    icon: 'cursor';
  };
  attributes: {
    accessibleLabel: Schema.Attribute.String;
    adminName: Schema.Attribute.String;
    backgroundColor: Schema.Attribute.String;
    borderColor: Schema.Attribute.String;
    ...
    fontWeight: Schema.Attribute.Integer;
    height: Schema.Attribute.String;
    href: Schema.Attribute.String & Schema.Attribute.Required;
    margin: Schema.Attribute.String;
    overflow: Schema.Attribute.Enumeration<['visible', 'hidden']>;
    padding: Schema.Attribute.String;
    slots: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
...
export interface BlocksGallery extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Grid/masonry layout of Image children';
    displayName: 'Gallery';
    icon: 'images';
    name: 'Gallery';
  };
...
export interface BlocksIcon extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Decorative icon leaf (lucide icon set)';
    displayName: 'Icon';
    icon: 'bulletList';
  };
  attributes: {
...
export interface BlocksIframe extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    aspect: Schema.Attribute.Enumeration<
      ['auto', '16:9', '4:3', '1:1', '21:9']
    > &
      Schema.Attribute.DefaultTo<'4:3'>;
    backgroundColor: Schema.Attribute.String;
    borderColor: Schema.Attribute.String;
    borderRadius: Schema.Attribute.String;
    borderStyle: Schema.Attribute.Enumeration<['solid', 'dashed', 'dotted']>;
...
export interface BlocksImage extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    borderWidth: Schema.Attribute.Integer;
    color: Schema.Attribute.String;
    fit: Schema.Attribute.Enumeration<['cover', 'contain', 'fill', 'none']> &
...
export interface BlocksLink extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Text/icon link container (nests Icon and/or Text)';
    displayName: 'Link';
    icon: 'link';
  };
  attributes: {
...
export interface BlocksSection extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    borderWidth: Schema.Attribute.Integer;
    color: Schema.Attribute.String;
    divider: Schema.Attribute.Enumeration<['none', 'top', 'bottom', 'both']> &
      Schema.Attribute.DefaultTo<'none'>;
    height: Schema.Attribute.String;
    margin: Schema.Attribute.String;
    maxWidth: Schema.Attribute.String;
    minHeight: Schema.Attribute.Enumeration<['standard', 'tall']>;
    overflow: Schema.Attribute.Enumeration<['visible', 'hidden']>;
    ...
    >;
    width: Schema.Attribute.Enumeration<['full', 'contained']> &
...
export interface BlocksText extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    padding: Schema.Attribute.String;
    textAlign: Schema.Attribute.Enumeration<['left', 'center', 'right']>;
    uppercase: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    width: Schema.Attribute.String;
  };
}
